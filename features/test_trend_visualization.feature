...
Feature: Test Trend Visualization Flow
  ...
  Scenario: Pyramid Flow
    Given a User uploads data with following attributes
      | proj     | platform | ci_job        | osName | hostName | browser | environment | date_year | date_month | date_day | date_hour | date_minute | logFile      | test_type        | test_report_type | test_sub_type    |
...
#    Given a User uploads data with following attributes
#      | proj     | platform | ci_job        | osName | hostName | browser | environment | date_year | date_month | date_day | date_hour | date_minute | logFile      | test_type | test_report_type |
