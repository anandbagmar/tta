Feature: Upload data to view test pyramid ,Comparative analysis graph and Defect Analysis
  ...
  Examples:
    ...
    |Project1|SubProj1|Run unit test|Mac    |Sailee   |IE     |DEV        |2012-01-01       |/var/lib/go-agent/pipelines/Development/tta-spec-results.zip |Unit Test       |
    |Project1|SubProj1|Run unit test|Mac    |Sailee   |IE     |DEV        |2012-02-20       |/var/lib/go-agent/pipelines/Development/tta-spec-results.zip |Integration Test|
    |Project1|SubProj1|Run unit test|Mac    |Sailee   |IE     |DEV        |2012-03-15       |/var/lib/go-agent/pipelines/Development/tta-spec-results.zip |Functional Test |
  ...
  Scenario: Error-Message Checking On UPLOAD PAGE
    ...
    When The user submits project details with "proj1","sub_proj1","ci_job1","osName1","hostName1","browser1","environment1","dateOfExecution1","/var/lib/go-agent/pipelines/Development/tta-spec-results.zip","test_type1"
    And The User clicks on the "reset_button" button
  ...
  Examples:
    ...
    |Project1|SubProj1|Run unit test|Mac    |Sailee   |IE     |DEV        |2012-02-20       |/var/lib/go-agent/pipelines/Development/tta-spec-results.zip |Integration Test|
    |Project1|SubProj1|Run unit test|Mac    |Sailee   |IE     |DEV        |2012-03-15       |/var/lib/go-agent/pipelines/Development/tta-spec-results.zip |Functional Test |
    |Project1|SubProj2|Run unit test|Mac    |Sanchar  |IE     |DEV        |2012-01-01       |/var/lib/go-agent/pipelines/Development/tta-spec-results.zip |Unit Test       |
    |Project1|SubProj2|Run unit test|Mac    |Sanchar  |IE     |DEV        |2012-03-31       |/var/lib/go-agent/pipelines/Development/tta-spec-results.zip |Integration Test|
