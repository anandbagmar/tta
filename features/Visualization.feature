Feature: Upload data to view test pyramid and Comparative analysis graph
  ...
  Examples:
      ...
      |Project1|SubProj1|Run unit test|Mac    |Sailee   |IE     |DEV        |2012-01-01       |/home/Desktop/cuke_running/tta_12spec_results.zip |Unit Test       |
      |Project1|SubProj1|Run unit test|Mac    |Sailee   |IE     |DEV        |2012-02-20       |/home/Desktop/cuke_running/tta_12spec_results.zip |Integration Test|
      |Project1|SubProj1|Run unit test|Mac    |Sailee   |IE     |DEV        |2012-03-15       |/home/Desktop/cuke_running/tta_12spec_results.zip |Functional Test |
  @wip
  ...
  Examples:
    ...
    |Project1|SubProj1|Run unit test|Mac    |Sailee   |IE     |DEV        |2012-02-20       |/home/Desktop/cuke_running/tta_12spec_results.zip |Integration Test|
    |Project1|SubProj1|Run unit test|Mac    |Sailee   |IE     |DEV        |2012-03-15       |/home/Desktop/cuke_running/tta_12spec_results.zip |Functional Test |
    |Project1|SubProj2|Run unit test|Mac    |Sanchar  |IE     |DEV        |2012-01-01       |/home/Desktop/cuke_running/tta_12spec_results.zip |Unit Test       |
    |Project1|SubProj2|Run unit test|Mac    |Sanchar  |IE     |DEV        |2012-03-31       |/home/Desktop/cuke_running/tta_12spec_results.zip |Integration Test|
  @wip
