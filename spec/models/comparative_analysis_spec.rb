...
describe ComparativeAnalysis do
  ...
  it "should return result set" do
    ...
    result = ComparativeAnalysis.new.get_result_set(sub_project.id,"1990-1-1","2012-12-12")
  ...
  it "should return result set with a single point if project has only one build between the date range" do
    ...
    result = ComparativeAnalysis.new.get_result_set(sub_project.id,"2013-01-01".to_date,"2013-03-30".to_date)
