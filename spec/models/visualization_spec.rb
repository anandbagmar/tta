...
describe Visualization do
  ...
  it "should return json with proper data" do
    ...
    test_metadata = FactoryGirl.create(:test_metadatum,:platform_id => platform.id,:ci_job_name => "build", :os_name=> "fedora" , :host_name => "pooja-pc" , :browser => "firefox" , :type_of_environment =>"Dev" ,:date_of_execution => "2012-12-12",:test_category=>"UNIT TEST" ,:test_report_type => "JUnit")
  ...
  it "should return json with test_types sorted by sequence number" do
    ...
    platform = FactoryGirl.create(:platform, :product_id => product.id,:name => "PLATFORM1.1")
    test_metadata = FactoryGirl.create(:test_metadatum,:platform_id => platform.id,:ci_job_name => "build", :os_name=> "fedora" , :host_name => "pooja-pc" , :browser => "firefox" , :type_of_environment =>"Dev" ,:date_of_execution => "2012-12-12",:test_category=>"UNIT TEST" ,:test_report_type => "JUnit")
    test_metadata_functional = FactoryGirl.create(:test_metadatum,:platform_id => platform.id,:ci_job_name => "build", :os_name=> "fedora" , :host_name => "pooja-pc" , :browser => "firefox" , :type_of_environment =>"Dev" ,:date_of_execution => "2012-12-12",:test_category=>"FUNCTIONAL TEST" ,:test_report_type => "JUnit")
