...
describe Visualization do
  ...
  it "should return json with proper data" do
    ...
    json.should eq("{\"sub_project_name\":\"SubProject1.1\",\"test_types\":[{\"test_name\":\"UNIT TEST\",\"seq_no\":101,\"percent\":\"100.00\",\"duration\":\"0.005000\",\"test_no\":30}],\"unknown_test_types\":null}")
  end
