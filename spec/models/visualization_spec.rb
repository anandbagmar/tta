...
describe Visualization do
  ...
  it "should return json with proper data" do
    ...
    json= Visualization.new.getResultJson(sub_project.id)
    json.should eq("{\"sub_project_name\":\"SUBPROJECT1.1\",\"test_types\":[{\"test_name\":\"UNIT TEST\",\"seq_no\":101,\"percent\":\"100.00\",\"duration\":\"00:00:05:000\",\"no_of_test\":30,\"percentage_passing\":\"93.33\"}],\"unknown_test_types\":null}")
  end
