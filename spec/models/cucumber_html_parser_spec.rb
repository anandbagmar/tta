describe CucumberHtmlParser do
  describe Visualization,ComparativeAnalysis,DefectAnalysis do
    ...
    it "should return proper json on valid data entry for Cucumber HTML Parser" do
      ...
      result_comparative = ComparativeAnalysis.new.get_result_set(project.id,sub_project.id,nil,"2013-01-01".to_date,"2013-03-30".to_date)
      result_comparative.should eq({"TTA_SUBPROJECT"=>{"UNIT TEST : UNIT TEST"=>[[1361318400000.0, 60.0]]}})
