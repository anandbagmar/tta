...
describe DefectAnalysis do
  ...
  it "should return json if sub_project_id passed" do
    ...
    json=DefectAnalysis.new.get_result_json(sub_project.id,"2013-02-19".to_date)
    json.should_not be_nil
  end

  it "should throw error when sub_project_id is nil" do
    expect{DefectAnalysis.new.get_result_json(nil,"2013-02-19".to_date)}.to raise_error
  end


  it "should throw error when analysis_date is nil" do
    expect{DefectAnalysis.new.get_result_json("1",nil)}.to raise_error
  end
  ...
  it "should return json with proper data" do
    ...
    json= DefectAnalysis.new.get_result_json(sub_project.id,"2013-02-20".to_date)
