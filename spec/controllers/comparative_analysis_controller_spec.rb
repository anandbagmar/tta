...
describe ComparativeAnalysisController, type: :controller do
  ...
  it "should return result set for all test sub category" do
    ...
    test_metadata1 = FactoryGirl.create(:test_metadatum, platform_id: platform.id, date_of_execution: yesterday)
    test_metadata2 = FactoryGirl.create(:test_metadatum, platform_id: platform.id, date_of_execution: today, test_category: "FUNCTIONAL TEST", test_sub_category: "REGRESSION TEST")
    test_metadata3 = FactoryGirl.create(:test_metadatum, platform_id: platform.id, date_of_execution: today, test_category: "FUNCTIONAL TEST", test_sub_category: "SMOKE TEST")
  ...
  describe "Get 'test_category_mapping_list'" do
    it "should return a list of test category and test sub category" do
      ...
      test_metadata1 = FactoryGirl.create(:test_metadatum, platform_id: platform.id, date_of_execution: Time.zone.yesterday.in_time_zone)
      test_metadata2 = FactoryGirl.create(:test_metadatum, platform_id: platform.id, date_of_execution: Time.zone.today.in_time_zone, test_category: "FUNCTIONAL TEST", test_sub_category: "REGRESSION TEST")
      test_metadata3 = FactoryGirl.create(:test_metadatum, platform_id: platform.id, date_of_execution: Time.zone.today.in_time_zone, test_category: "FUNCTIONAL TEST", test_sub_category: "SMOKE TEST")
